...
\titlerunning{\small\color{gray}Projets de Logiciel Libre Accessibles aux Nouveaux Contributeurs}
\author{%
    Paul Hervot\inst{1}%
    \and%
...
\authorrunning{\small\color{gray}Environnements Informatiques pour l’Apprentissage Humain 2023}
