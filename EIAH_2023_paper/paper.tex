...
\begin{document}
    ...
    \todo{TODO : enlever les footnotes, y'en a trop}
    ...
    requêtes HTTP sur le site web \url{https://archive.softwareheritage.org/}\todo{TODO : ne mentionner le
    lien qu'une seule fois et le réduire (sans https:// machin)}, accessible publiquement, soit en
    téléchargeant les contenus directement depuis leur "\en{registry}" Amazon
