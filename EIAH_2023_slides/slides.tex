...
\begin{frame}{Mémoire de Master}
    ...
    \note[item]{%
        ...
        dernière en formation continue et supervisé par mon co-autheur, qui n'a
...
\begin{frame}[fragile]{Contributions au logiciel libre}
    ...
    \note[item]{%
        ...
        étudiants comme execrice "monde réel".
    }
\end{frame}
...
\begin{frame}[fragile]{Inspiration}
    ...
    \note[item]{%
        ...
        arrivent à contribuer, leur code est merged dans le projet) et non
...
\begin{frame}{Conclusion}
    ...
    accesibles aux nouveaux contributers, deux légers sont proposés dans cet
    article.
