...
\todo[inline]{TODO : Étoffer et rédiger}
...
contribution aux projets de logiciel libre dans leurs cursus d'informatique \sideparencite{oss-edu-2008,
oss-edu-2007}.
...
\todo[inline]{%
    ...
    Peut être regarder du côté de l'\en{Oregon State University} qui, d'après \textcite{barriers-2018},
    héberge un \acrfull{OSL} hébergeant lui-même "\en{one of the largest number of Open Source projects in the
    world}". Ils font peut être des cours spécifiquement pour les logiciels libres avec un truc pareil.%
}
