...
\newglossaryentry{API}{
    ...
    description={
        ...
        plateforme (comme le nom des projets hébergés, le nombre de \englpl{pull request} d'un projet
        spécifique, les auteurs de \englpl{commit}, etc.), et cela sans utiliser de navigateur web
    },
}
...
\newglossaryentry{pull request}{
    ...
    description={
        ...
        \englpl{commit} que des personnes internes ou externes au projet soumettent à la validation des
        personnes ayant la permission de modifier son code source. Les pull request font typiquement l'objet
        de relectures, commentaires et demandes d'ajustement de la part des contributeurs habitués et reconnus
        du projet
    },
}
