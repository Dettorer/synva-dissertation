...
\newglossaryentry{API}{
    name=\en{API},
    description={
        Accronyme pour "\en{Application Programming Interface}", les \en{APIs} sont des collections d'outils
        logiciel permettant à un programme d'interagir avec un service logiciel sans utiliser l'interface
        utilisateur usuelle du service en question, on parle donc d'interface logicielle. Par exemple,
        l'\en{API} du site \gls{github} (détaillée ici : \url{https://docs.github.com/en/rest}) permet aux
        développeurs et chercheurs d'écrire des programmes collectant automatiquement des données de la
        plateforme (comme le nom des projets hébergés, le nombre de \glspl{pull request} d'un projet
        spécifique, les auteurs de \glspl{commit}, etc.), et cela sans utiliser de navigateur web
    },
}
...
\newglossaryentry{fosdem}{
    ...
    description={
        ...
        présentations, ateliers et discussions autour du logiciel libre
    },
}
...
\newglossaryentry{pull request}{
    ...
    description={
        ...
        l'objet de relectures, commentaires et demandes d'ajustement de la part des contributeurs habitués et
        reconnus du projet
    },
}
