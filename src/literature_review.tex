...
contributeurs ("\en{newcomers openness}" dans l'article) est le pourcentage de \glspl{pull request} créées par
...
\gls{git} ou des versions de paquets Python publiés sur PyPi\sidenote{\url{https://pypi.org/}}) et augmente de
