...
\todo[inline]{%
    ...
    critère d'exclusion : une origine a des commits en commun avec une autre et a moins de commits entre
    l'origine et son commit le plus éloigné que cette autre.
}
