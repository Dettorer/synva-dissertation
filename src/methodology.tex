...
\newhyp{recentcontributorcount}{%
    le nombre de contributeurs uniques récents (du premier janvier 2019 au premier juin 2019) d'un projet est
    positivement corrélée à son accessibilité pour les nouveaux contributeurs
    \parencite[voir][p.~12-13,16]{signals-2019}.%
}

\newhyp{recentcommitcount}{%
    le nombre de \glspl{commit} récents (du premier janvier 2019 au premier juin 2019) au sein d'un projet est
    positivement corrélé à son accessibilité pour les nouveaux contributeurs
...
\todo[inline]{%
    Retravailler cette description, n'en garder qu'un résumé dans cette section et reléguer le détail en
    annexe.
}
