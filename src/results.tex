...
\todo[inline]{TODO : analyser hasContrib et rédiger.}
...
\todo[inline]{%
    Pour vérifier à quel point cette différence de moyenne s'explique effectivement par \texttt{hasContrib},
    il faudrait faire une one-way ANOVA, mais apparemment il faut que la population de base suive une loi
    normale, ce qui n'est pas du tout le cas, il y a peut être une application du théorème central limite qui
    peut m'aider ?%
}
